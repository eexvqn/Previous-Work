...
**Solution:** CSV stands for comma-seperated values. It allows data to be stored in the format of a table. It is popular as it takes up little space, compared to Excel, and is less prone to corruption since the files are in plain text.
...
```
<br>
```{r, out.height= "400px",out.width= "565px",echo=TRUE,eval=TRUE,fig.cap="Information about read_csv()"}
knitr::include_graphics("/Users/eexuan/Downloads/AY2324 Sem1/NM2207/Previous-Work/Week-2/challenge/Help.png")
```
<br>

**Question 1.6:** What does the `skip` argument in the read_csv() function do?

**Solution:** It allows us to skip a certain number of rows for us to study the data better.
<br>
<br>
...
aes(x=Age,y=Rating) + 
  geom_point(colour = "blue", shape = 15) +
  labs(x="Age", y="Rating", title="Ratings of Music against Age of Listeners",  
caption="Source: playlist_data")
