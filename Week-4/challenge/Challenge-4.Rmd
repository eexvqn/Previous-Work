...
**Solution:** 
1. There are mulitple variables stored within one column (i.e., the demographic and the employment status are both stored under the "subject" column).
2. The type of value stored in the column is not consistent (i.e., numbers are being stored under "percent" column).

How it can be improved - There can be new columns for employment status, gender and age.